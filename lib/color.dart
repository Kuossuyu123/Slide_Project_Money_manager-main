...
List<TextStyle> HCardAsText=[
  TextStyle(color: Colors.orange.shade300,fontSize: 30),
...
List<TextStyle> HCardInText=[
  TextStyle(color: Colors.orange.shade300,fontSize: 20),
  TextStyle(color: Colors.purple.shade300,fontSize: 20),
];

//$income (money)------
List<TextStyle> HCardMInText=[
  TextStyle(color: Colors.orange.shade300,fontSize: 20,fontWeight: FontWeight.bold),
